...
#Region "Variables Globales"
    ...
    Public _detalleCompras As DataTable 'Almacena el detalle para insertar a la tabla TPA001 del BDDiconDinoNatu
#End Region
...
#Region "Metodos Privados"
    ...
    Private Sub _prCargarComboLibreriaSucursal(mCombo As Janus.Windows.GridEX.EditControls.MultiColumnCombo)
        ...
        With mCombo
            ...
            .DropDownList.Columns.Add("aabdes").Width = 250
    ...
    Public Sub _prMostrarRegistro(_N As Integer)
        ...
        'Recuperar datos si es con factura
    ...
    Private Sub _prCargarFacturacion(_numi As String)
        ...
        'tbNFactura.Text = dtC.Rows(0).Item("fcanfac")
    ...
    Public Function _ValidarCampos() As Boolean
        Try
            ...
            End If
            If VerificarIntegracionCompras(tbFechaVenta.Value.ToString("yyyy/MM/dd")) Then
    ...
    Public Sub _GuardarNuevo()
        ...
        RecuperarDatosTFC001()  'Recupera datos para grabar en la BDDiconDinoNatu en la Tabla TFC001
