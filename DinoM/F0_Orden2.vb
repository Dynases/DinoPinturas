...
Public Class F0_Orden2
    ...
    '    Private Sub grdetalle_Enter(sender As Object, e As EventArgs)
    '        Try
    '            If (_fnAccesible()) Then
    '                If (_CodCliente <= 0) Then
    ...
    '        End Try
    '    End Sub
    '    Private Sub grdetalle_KeyDown(sender As Object, e As KeyEventArgs)
    '        Try
    ...
    '    End Sub
    '    Private Sub tbPdesc_ValueChanged(sender As Object, e As EventArgs)
    ...
    '    Private Sub tbMdesc_ValueChanged(sender As Object, e As EventArgs)
    ...
    '    Private Sub grdetalle_CellEdited(sender As Object, e As ColumnActionEventArgs)
    '        Try
    ...
    '    Private Sub SwProforma_ValueChanged(sender As Object, e As EventArgs)
    '        If (_fnAccesible()) Then
    ...
    '    Private Sub TbNombre1_TextChanged(sender As Object, e As EventArgs)
