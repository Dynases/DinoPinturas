...
#End Region
    ...
    Private Sub btConfFormula_Click(sender As Object, e As EventArgs) Handles btConfFormula.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F0_Formula
        frm._nameButton = btConfFormula.Name
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btProdFormulaProduccion_Click(sender As Object, e As EventArgs) Handles btProdFormulaProduccion.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F0_FormulaProduccion
        frm._nameButton = btProdFormulaProduccion.Name
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btOrdenPed_Click(sender As Object, e As EventArgs) Handles btOrdenPed.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F0_Orden
        frm._nameButton = btOrdenPed.Name
        frm._modulo = FP_VENTAS
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
