...
#Region "TC001 Compras"
    ...
    Public Shared Function L_fnListarProveedores() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarUnProveedor(_cod As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "TP002 Productos Compuestos"
    Public Shared Function L_fnGrabarProductoCompuesto(ByRef _id As String, _idVenta As String, _codProducto As String, _tipo As Integer, _fecha As String, _fechaVencimiento As String,
        ...
        Return _resultado
    End Function
    Public Shared Sub L_ProductoCompuestoCabecera_Grabar2(ByRef _id As String, _cod As String, _estado As String, _descrip As String, _observa As String, _fecha As String, _fechaFab As String, _fechaVen As String, _sucursal As String, _total As String)
        Dim _Actualizacion As String
        Dim _Err As Boolean
        Dim _Tabla As DataTable
        _Tabla = D_Maximo("TP002", "pcnumi", "pcnumi=pcnumi")
        If Not IsDBNull(_Tabla.Rows(0).Item(0)) Then
        ...
        End If
        _Actualizacion = "'" + Date.Now.Date.ToString("yyyy/MM/dd") + "', '" + Now.Hour.ToString + ":" + Now.Minute.ToString + "' ,'" + L_Usuario + "'"
        Dim A As String = "'" + _cod + "',"
        Dim Sql As String
        Sql = "'" + _cod + "'," + _estado + ",'" + _fecha + "','" + _fechaFab + "','" + _fechaVen + "','" + _descrip + "','" + _observa + "'," + _total + "," + _Actualizacion
        _Err = D_Insertar_Datos("TP002", Sql)
    End Sub
    Public Shared Function L_ProductoCompuestoCabecera_Grabar(ByRef _id As String, _pcIdProducto As String, _pcIdDetalleFormula As String,
    ...
    Public Shared Function L_fnProductoCompuestoTraerGeneralXId(_id As String, _idAlmacen As String) As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@pcnumi", _id))
        _listParam.Add(New Datos.DParametro("@almacen", _idAlmacen))
        _listParam.Add(New Datos.DParametro("@pcuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TP002", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_fnProductoCompuestoTraerDetalleXId(_id As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarProductosCompuestos(_almacen As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnProductoCompuestoTraerGeneral_Venta(_IdVenta As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_FormulaProduccion_Buscar(_idAlmacen As String, _fechaIni As String, _fechaFinal As String, _Estado As String) As DataTable
        Dim _Tabla As DataTable
        Dim sb As New StringBuilder
        sb.Append("
                    SELECT 
	                    a.pcnumi  as Id,
	                    a.pccod as Codigo,
	                    a.pcdesc as ProductoTerminado,
	                    a.pcCantidad  as Cantidad,
	                    a.pcfech as Fecha,
	                     CASE a.pcEstado  WHEN 1 THEN 'PENDIENTE'
							                    WHEN 2 THEN 'COMPLETADO' END AS Estado
                    FROM
	                    TP002  A
                    where
	                    a.pcest = 2 and a.pcEstado > 0 AND  ")
        If _idAlmacen > 0 Then
            sb.Append(String.Format(" a.pcAlmacen = {0} AND   ", _idAlmacen))
        End If
        If _fechaIni <> String.Empty Then
            sb.Append(String.Format(" a.pcfech>= '{0}'   and a.pcfech <= '{1}'  AND   ", _fechaIni, _fechaFinal))
        End If
        If _Estado = 1 Or _Estado = 2 Then
            sb.Append(String.Format(" A.pcEstado = {0} AND   ", _Estado))
        End If
        If _Estado = 3 Then
            sb.Append(" A.pcEstado IN (1,2) AND   ")
        End If
        sb.Length = sb.Length - 7
        sb.Append(" ORDER BY  a.pcnumi DESC")
        _Tabla = D_Datos_EjecutarConulta(sb.ToString())
        Return _Tabla
    End Function
    ...
    Public Shared Function L_fnProductoCompuesto_TraerUnidadPresentacion(_idProducto As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnProductoCompuesto_Etiqueta(_idFormula As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnProductoCompuesto_Produccion_Etiqueta(_idFormula As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "Orden de Pedido"
    Public Shared Function L_GrabarOrdenPedido(ByRef _id As String, _fecha As String, _cliente As String, _fechaentr As String, _pedido As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@oanumi", _id))
        _listParam.Add(New Datos.DParametro("@oafdoc", _fecha))
        _listParam.Add(New Datos.DParametro("@oacliente", _cliente))
        _listParam.Add(New Datos.DParametro("@oafentr", _fechaentr))
        _listParam.Add(New Datos.DParametro("@oaped", _pedido))
        _listParam.Add(New Datos.DParametro("@oaest", 1))
        ...
        Return _resultado
    End Function
    Public Shared Function L_ModificarOrdenPedido(ByRef _id As String, _fecha As String, _cliente As String, _fechaentr As String, _pedido As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnOrdenGeneral() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnEliminarOrden(numi As String, ByRef mensaje As String) As Boolean
        Dim _resultado As Boolean
